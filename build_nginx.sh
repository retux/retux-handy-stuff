...
function uninstall_predependencies {
    ...
    sudo dnf remove unzip wget
    echo "Uninstall Extra Packages"
    echo "----------------------"
	echo
    echo "Uninstall optional NGINX dependencies (using pkg manager):"
    sudo dnf remove -y perl perl-devel perl-ExtUtils-Embed libxslt libxslt-devel libxml2 libxml2-devel gd gd-devel GeoIP GeoIP-devel
}
